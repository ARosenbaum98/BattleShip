...
void getCommand(){
    ...
    cout<<endl;
    if(command=="help"){
        cout<<"shoot <coordinate>: Shoot at specified coordinates"<<endl<<
        "show grid: Show the game grid"<<endl<<
        "show solution: Show the solution"<<endl<<
        "show statistics: Show statistics of the game"<<endl<<
        "start new: End your current game and start a new one"<<endl<<
        "help: Display this help message"<<endl<<
        "quit: End game and exit the program;"<<endl;
